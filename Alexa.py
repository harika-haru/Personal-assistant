...
print('hello I am your personal assistant, Joy ,Come,lets work together.')
...
speak(" Hello I am your personal assistant,  Joy  Come,lets work together.")
greetUser()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'say hi' in statement:
            ...
            speak('I am Joy ,your personal assistant' 'I will do simple task like opening youtube,google chrome,'
                  'gmail ,gmeet,tinkerhub,predict time,search wikipedia'
                  'and get top headline news from The Hindu' 'I am here to make your work simple')
            print('I am Joy ,your personal assistant. I will do simple task like opening youtube,google chrome,gmail,'
                  'gmeet, tinkerhub,predict time,search wikipedia and get top headline news from The Hindu.'
                  'I am here to make your work simple.')

        elif "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
            speak("I was built by harika")
            print("I was built by harika")
            ...
            speak('your personal assistant Joy is shutting down,Good bye')
            print('your personal assistant Joy is shutting down,Good bye')
            break
